export const ITEM_DEFS = {
    BulletBooster: {
        ...
        apply: (player) => player.addEffect("bullet", 1, 5),
    ...
    EggSpeedBooster: {
        ...
        apply: (player) => player.addEffect("eggSpeed", 1, 5),
    ...
    EggSizeBooster: {
        ...
        apply: (player) => player.addEffect("eggSize", 1, 5),
    ...
    SpeedBooster: {
        ...
        apply: (player) => player.addEffect("speed", 1, 5),
